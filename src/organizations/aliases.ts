...
/**
 * Type aliases for the organizations component, parameterised by a
...
export const legacyAliases = (
  ...
  organizationalUnits: Alias[]
} => ({
  organizationalUnits: [{ type: `${prefix}:organizations:OrganizationalUnits` }],
})
